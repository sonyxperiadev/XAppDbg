...
public class XAppDbgCmdWriteProp extends XAppDbgCommand {

    private XAppDbgPropertiesModule mMod;

    public XAppDbgCmdWriteProp(XAppDbgPropertiesModule mod) {
        super(XAppDbgCmdIDs.CMD_WRITE_PROP);
        mMod = mod;
    }

    @Override
    public boolean exec(Packet in, Packet out) throws IOException {
        return mMod.cmdWriteProp(in, out);
    }
