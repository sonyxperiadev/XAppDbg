...
public class XAppDbgCmdTreeSelect extends XAppDbgCommand {

    private XAppDbgTreeModule mMod;

    public XAppDbgCmdTreeSelect(XAppDbgTreeModule mod) {
        super(XAppDbgCmdIDs.CMD_TREE_SELECT);
        mMod = mod;
    }

    @Override
    public boolean exec(Packet in, Packet out) throws IOException {
        return mMod.cmdTreeSelect(in, out);
    }
