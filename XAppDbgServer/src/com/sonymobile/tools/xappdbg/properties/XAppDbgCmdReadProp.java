...
public class XAppDbgCmdReadProp extends XAppDbgCommand {

    private XAppDbgPropertiesModule mMod;

    public XAppDbgCmdReadProp(XAppDbgPropertiesModule mod) {
        super(XAppDbgCmdIDs.CMD_READ_PROP);
        mMod = mod;
    }

    @Override
    public boolean exec(Packet in, Packet out) throws IOException {
        return mMod.cmdReadProp(in, out);
    }
