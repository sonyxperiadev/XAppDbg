...
public class XAppDbgCmdTrigger extends XAppDbgCommand {

    private XAppDbgTriggerModule mMod;

    public XAppDbgCmdTrigger(XAppDbgTriggerModule mod) {
        super(XAppDbgCmdIDs.CMD_TRIGGER);
        mMod = mod;
    }

    @Override
    public boolean exec(Packet in, Packet out) throws IOException {
        return mMod.cmdDo(in, out);
    }
